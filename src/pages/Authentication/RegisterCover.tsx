...
import { setPageTitle, toggleSemidark, toggleTheme, toggleRTL } from '../../store/themeConfigSlice';
...
const RegisterCover = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const isValidPassword = pwd.length >= 8 && /[A-Z]/.test(pwd) && /[0-9]/.test(pwd) && /[!@#$%^&*(),.?":{}|<>]/.test(pwd);
        ...
        try {
            ...
            await axios.get(`${config.API_BASE_URL}v1/verifyEmail/${token}`);
            
            // Update password
            await axios.post(`${config.API_BASE_URL}v1/setPassword`, {
                    ...
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        ...
                        <div className="w-full max-w-[440px] lg:mt-16">
                            <div className="mb-10">
                                ...
                                <p className="text-base font-bold leading-normal text-white-dark">Enter your password to complete registration</p>
                            </div>
                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        ...
                                        <button
                                            type="button"
                                            className="absolute end-4 top-1/2 -translate-y-1/2 text-white-dark hover:text-primary"
                                    ...
                                    <div className="mt-2" style={{ minHeight: formData.password ? 'auto' : '0', overflow: 'hidden' }}>
                                        {formData.password && (
                                            <>
                                                <style>{`
