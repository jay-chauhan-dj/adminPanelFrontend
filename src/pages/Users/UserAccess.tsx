                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                    {availableAreas.map((area) => (
                                        <label key={area} className={`flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all ${currentRole.access_area.includes(area)
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {availableAreas.filter(area => !currentUser.roleAreas.includes(area)).map((area) => {
                                        ...
                                        return (
                                            <label key={area} className={`flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all ${isChecked
                                                    ? 'border-primary bg-primary/5'
                                                    : 'border-gray-200 dark:border-gray-700 hover:border-primary/50'
                                                }`}>
                                                <input
